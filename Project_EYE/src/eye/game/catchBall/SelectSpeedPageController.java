...
public class SelectSpeedPageController {
    ...
    void backButtonAction(ActionEvent event) {
    	try {
    		Parent IntroducePage = FXMLLoader.load(getClass().getResource("IntroducePage.fxml"));  // 불러올 페이지 지정
...
//			scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());  // css 지정
    ...
    void easyButtonAction(ActionEvent event) {
    	gameSpeed = 5;
    	try {
    		Parent CatchBallGame = FXMLLoader.load(getClass().getResource("CatchballGame.fxml"));  // 불러올 페이지 지정
			Scene scene = new Scene(CatchBallGame);
//			scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());  // css 지정
			Stage primaryStage = (Stage) easyButton.getScene().getWindow();  // 현재 윈도우 가져오기
			primaryStage.setScene(scene);
    ...
    void hardButtonAction(ActionEvent event) {
    	...
    	try {
			...
			Scene scene = new Scene(CatchBallGame);
//			scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());  // css 지정
			Stage primaryStage = (Stage) normalButton.getScene().getWindow();  // 현재 윈도우 가져오기
			primaryStage.setScene(scene);
			primaryStage.setTitle("CatchBallGame!");
		} catch (Exception e) {
			e.printStackTrace();
    ...
    void normalButtonAction(ActionEvent event) {
    	...
    	try {
			...
			Scene scene = new Scene(CatchBallGame);
//			scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());  // css 지정
			Stage primaryStage = (Stage) hardButton.getScene().getWindow();  // 현재 윈도우 가져오기
			primaryStage.setScene(scene);
			primaryStage.setTitle("CatchBallGame!");
		} catch (Exception e) {
			e.printStackTrace();
