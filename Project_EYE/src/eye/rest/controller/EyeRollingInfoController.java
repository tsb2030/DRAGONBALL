...
public class EyeRollingInfoController implements Initializable {
	...
	@FXML
	private Button eyeRollingNextBtn;  // 시작 버튼

	@FXML   /* 눈 굴리기 설명 페이지에서 시작버튼 누르면 실행 페이지로 이동 */
	...
	@FXML   /* 눈 굴리기 설명 페이지에서 뒤로가기 누르면 휴식 메인 페이지로 이동 */
